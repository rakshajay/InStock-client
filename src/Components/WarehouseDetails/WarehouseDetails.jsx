...
function WarehouseDetails() {
  ...
  useEffect(() => {
    ...
    <div className="warehouse-details">
      ...
      <p className="warehouse-details__contact-title">WAREHOUSE ADDRESS</p>
      ...
      <div className="warehouse-details__contact-details">
        ...
        <div className="warehouse-details__contact-information">
          <p className="warehouse-details__contact-title">CONTACT INFORMATION</p>
      ...
      <List itemList={inventoryList} columns={columns} header='Warehouses' singularLabel="Warehouse" />
      </div>
